...
\begin{document}
\documentotitolo{Report tecnico}{Alberi di regressione}

Il report descrive la versione client/server del progetto di Metodi avanzati
di programmazione, dedicato all'apprendimento e all'utilizzo di alberi di
regressione.
